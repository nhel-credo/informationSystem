...
INSERT INTO `subjects` (`id`, `title`, `description`, `time`, `schedule`, `created_at`, `updated_at`) VALUES
(3, 'mathematics', 'plus plus', '9:00 - 10:00 am', 'Daily', '2022-11-05 07:27:12', '2022-11-05 07:27:12'),
(5, 'C programming', 'type type lang', '7:00-8:00', 'MWF- SAT', '2022-11-05 08:07:34', '2022-11-05 08:07:34');
...
(1, 'user1', 'user1@email.com', '$2y$10$vP1ssfTRTeyAN9fx1432c.XaY2UMSjlds4Ic7eCyRf3r2uNSI4r0q', NULL, NULL, NULL),
(2, 'user2', 'user2@email.com', '$2y$10$e4is73q3ypZs6IujJU9iq.oKuHgbY1EV0I8N1kCa1NFAScdVT1n/q', NULL, NULL, NULL),
(5, 'admin', 'admin@email.com', '$2y$10$bJAtoXFZTKq5aImHyzdJaOCrxfkyb8VWargOVjfK4xdkHsFzsfGtK', NULL, NULL, NULL);
